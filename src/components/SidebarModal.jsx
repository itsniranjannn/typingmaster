...
export default function SidebarModal({ isOpen, onClose, isDark, bestWpm, bestWpmLabel, liveWpm, resetKey, streakInfo, dailyGoalProgress, dailyChallenge, dailyChallengeHistory, onStartChallenge }) {
